...
public class GuideView extends BaseGuideView {
	 ...
	 *            Type of layout pass
	 * @param attached
	 *            View on screen or NULL if there is no view
	 * @param currentRowHeight
	 *            Height of current row
	 * @param currentY
	 *            Current Y coordinate on the screen
	 * @param resizedPercent
	 *            Resized percent of the view
	 * @param channelIndex
	 *            Index of channel
	 * @param eventIndex
	 *            Index of Event
